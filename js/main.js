...
const ruta = {
    ...
    autocompletar: function (autocomplete, infoWindows, marker) {
        autocomplete.addListener('place_changed', function () {
            infoWindows.close();
            marker.setVisible(false);
            let place = autocomplete.getPlace();
            ruta.marcarUbicacion(place, infoWindows, marker);
        });
    },
    ...
    ubicacionAutomatica: function (position) {
        ...
        detallesOrigen.open(ruta.variable.map, markerOrigen);
    },

    marcarUbicacion: function (place, infoWindows, marker) {
        if (!place.geometry) {
        ...
        infoWindows.open(ruta.variable.map, marker);
    },
